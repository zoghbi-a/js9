...
0>c.toString().search(a.SUPERMENU)){for(d=0;d<a.displays.length;d++)if(c===a.displays[d]||c===a.displays[d].id||c===a.displays[d].oid)return a.displays[d];if("string"===typeof c)for(c=c.replace(e,""),c=c.replace("JS9",a.DEFID),d=0;d<a.displays.length;d++)if(c===a.displays[d]||c===a.displays[d].id||c===a.displays[d].oid)return a.displays[d];if(b)a.error("can't find JS9 display with id: "+c);else return null}return a.displays[0]};a.getImage=function(c){var b=a.lookupImage(c);!b&&(c=a.lookupDisplay(c,
!1))&&(b=c.image);return b};a.lookupVfile=function(c){var b,d,e=[];if(!c)return e;for(b=0;b<a.images.length;b++){var f=a.images[b];for(d=0;d<f.raws.length;d++){var g=f.raws[d];g.hdu&&g.hdu.fits&&c===g.hdu.fits.vfile&&e.push({im:f,raw:g,idx:d})}}return e};a.loadScript=function(a,b,d){var c=document.getElementsByTagName("head")[0],f=document.createElement("script");f.type="text/javascript";b&&(f.onload=b);d&&(f.onerror=d);f.src=a;c.appendChild(f)};a.fetchURL=function(c,b,d,e){var f=new XMLHttpRequest;
d=d||{};c||b||a.error("invalid url specification for fetchURL");b||(b=c,c=/([^\\/]+)$/.exec(b)[1]);c||(c=/([^\\/]+)$/.exec(b)[1]);d.proxy&&a.globalOpts.cgiProxy&&b.match(/\.(fits|ftz|fz|fits\.gz|fits\.bz2)(\?.*)?$/)&&(b=a.globalOpts.cgiProxy+"?fits="+b);var g=d.allowCache||b.match(/\?/)?b:b+"?r="+Math.random();g=g.replace(/^\${JS9_DIR}\//,a.INSTALLDIR);f.open("GET",g,!0);f.responseType=d.responseType?d.responseType:"blob";a.globalOpts.xtimeout&&(f.timeout=a.globalOpts.xtimeout);f.onload=function(){if(4===
f.readyState)if(200===f.status||0===f.status)if(delete a.fetchURL.status,"blob"===f.responseType){var g=new Blob([f.response]);c.match("://")?g.name=c.split("/").reverse()[0].replace(/\?.*$/,""):g.name=c;"uc"===g.name&&(g.name="google_"+a.uniqueID()+".fits");e?e(g,d):a.Load(g,d)}else d.display?e(f.response,d,{display:d.display}):e(f.response,d);else 404===f.status?a.error("could not find "+b):a.error("can't load: "+b+" "+f.statusText+" "+f.status)};f.onerror=function(){a.error("cannot load: "+b+" ... please check the url/pathname")};
...
a.globalOpts.image.xdim:a.notNull(a.globalOpts.xmax)&&(a.fits.options.image.xdim=a.globalOpts.xmax),a.notNull(a.globalOpts.image.ydim)?a.fits.options.image.ydim=a.globalOpts.image.ydim:a.notNull(a.globalOpts.ymax)&&(a.fits.options.image.ydim=a.globalOpts.ymax));a.fits.maxFITSMemory&&a.globalOpts.maxMemory&&a.fits.maxFITSMemory(a.globalOpts.maxMemory);break;default:a.error("unknown fits library: "+c)}a.fits.ready=!0;a.fits.name=b;a.fits.options.error=a.error;a.fits.options.waiting=a.waiting;return b};
a.handleFITSFile=function(c,b,d){a.fits.handleFITSFile?a.fits.handleFITSFile(c,b,d):a.error("no FITS module available to process FITS file")};a.cleanupFITSFile=function(c,b){var d;a.hostFS&&(d=new RegExp("^"+a.hostFS));return a.fits.cleanupFITSFile&&c&&c.hdu&&c.hdu.fits?(d&&c.hdu.fits.vfile&&c.hdu.fits.vfile.match(d)&&(b=!1),a.fits.cleanupFITSFile(c.hdu.fits,b),!0):!1};a.handleImageFile=function(c,b,d){var e=new FileReader;b=$.extend(!0,{},a.fits.options,b);d=d||a.Load;e.onload=function(a){var e,
f,k,m=new Image;m.onload=function(){var a=0;var g=document.createElement("canvas");var h=g.getContext("2d");var n=m.height,u=m.width;g.width=u;g.height=n;h.drawImage(m,0,0);e=h.getImageData(0,0,u,n).data;f=new Float32Array(n*u);for(h=0;h<n;h++)for(g=0;g<u;g++){var x=.299*e[a]+.587*e[a+1]+.114*e[a+2];f[(n-h)*u+g]=x;a+=4}k={filename:c.name,naxis:2,axis:[0,u,n],bitpix:-32,bin:1,head:{SIMPLE:!0,BITPIX:-32,NAXIS:2,NAXIS1:u,NAXIS2:n},data:f,offscreen:m};k.dmin=Number.MAX_VALUE;k.dmax=Number.MIN_VALUE;for(a=
0;a<n*u;a++)!Number.isNaN(k.data[a])&&Number.isFinite(k.data[a])&&(k.dmin=Math.min(k.dmin,k.data[a]),k.dmax=Math.max(k.dmax,k.data[a]));b.source="img";d(k,b)};m.src=a.target.result};e.readAsDataURL(c)};a.getFITSImage=function(c,b,d,e){a.fits.getFITSImage?a.fits.getFITSImage(c,b,d,e):a.error("no FITS module available to process FITS image")};a.fits2fits=function(c,b,d,e){var f,g={};d=d||{};var h=a.notNull(d.fits2fits)?d.fits2fits:a.globalOpts.fits2fits;!0===h?h="always":!1===h&&(h="never");if(h.match(/never/i))return!1;
if(!a.helper.connected||"nodejs"!==a.helper.type&&"socket.io"!==a.helper.type)return"always"===h&&a.globalOpts.requireFits2Fits&&a.error("can't run fits2fits without connected JS9 helper"),!1;if(!a.helper.js9helper)if(a.globalOpts.requireFits2Fits)a.error("js9helper not found for fits2fits processing");else return!1;if(!a.globalOpts.workDir)return a.globalOpts.requireFits2Fits&&a.error("can't run fits2fits without a workdir"),!1;var k=d.xdim||a.fits.options.image.xdim||a.fits.options.table.xdim;var m=
d.ydim||a.fits.options.image.ydim||a.fits.options.table.ydim;var l=d.bin||a.fits.options.image.bin||a.fits.options.table.bin;var p=d.binMode||a.globalOpts.binMode;p="a"===p?"a":"";"string"===typeof l&&(l.match(/[as]$/)&&(p=l.slice(-1)),l=parseInt(l,10));l=Math.max(1,l||1);a.notNull(d.xcen)&&a.notNull(d.ycen)?g.sect=k+"@"+d.xcen+","+m+"@"+d.ycen+","+l+p:g.sect=k+","+m+","+l+p;m=h.toLowerCase().split(/[>,]/);for(k=0;k<m.length;k++)switch(m[k]){case "size":m[k+1]&&(a.isNumber(m[k+1])&&(g.maxsize=1E6*
parseFloat(m[k+1])),k++)}g.fits=a.cleanPath(b);g.parent=!0;a.waiting(!0,c);a.helper.send("fits2fits",g,function(b){b="object"===typeof b?b:0<=b.search(a.analOpts.epattern)?{stderr:b}:{stdout:b};b.stderr&&a.error(b.stderr,a.analOpts.epattern);if(b.stdout){b.stdout.match(/^ERROR:/)&&(a.globalOpts.requireFits2Fits?a.error(b.stdout):b.stdout=g.fits);var h=b.stdout.split(/\n/);b=a.cleanPath(h[0]);if(b===g.fits)var k=$.extend(!0,{},d);else{"/"!==b.charAt(0)&&(b=a.InstallDir(b));k=$.extend(!0,{},d);delete k.xcen;
delete k.ycen;delete k.bin;void 0!==k.xdim&&(k.xdim=0);void 0!==k.ydim&&(k.ydim=0);k.source="fits2fits";k.proxyFile=b;if(h[1]){try{f=JSON.parse(h[1])}catch(x){}f&&(k.extname=f.extname,k.extnum=f.extnum,k.hdus=f.hdus,k.parent=f)}h[2]&&(h=a.cleanPath(h[2]),k.parentFile=h,k.extname?(k.parentFile=k.parentFile.replace(/\[.*\]/,""),k.parentFile+="["+k.extname+"]"):k.extnum&&0<k.extnum&&(k.parentFile=k.parentFile.replace(/\[.*\]/,""),k.parentFile.file+="["+k.extnum+"]"));e&&(k.onload=e)}k.fits2fits=!1;a.Load(b,
k,{display:c})}});return!0};a.lookupColormap=function(c,b){var d;void 0===b&&(b=!0);c||(c=a.imageOpts.colormap);if(c)for(d=0;d<a.colormaps.length;d++)if(a.colormaps[d].name===c)return a.colormaps[d];if(b)a.error("unknown colormap '"+c+"'");else return null};a.lookupCommand=function(c){var b;if(c){var d=c.toLowerCase();for(b=0;b<a.commands.length;b++)if(c=a.commands[b],c.name===d||c.alias===d||c.alias2===d)return c}return null};a.error=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];
var e=$jscomp.makeIterator(b);d=e.next().value;var f=e.next().value;e=e.next().value;var g,h,k,m="",l="",p=!0;a.waiting(!1);"processing"===a.fetchURL.status&&(a.fetchURL.status="error");for(h=0;h<a.images.length;h++){var r=a.images[h];(k=r.status.cur)&&r.status[k]&&r.setStatus(k,"error")}"string"===typeof f?(f=d.match(f))?f[1]?d=f[1]:f[0]&&(d=f[0]):p=!1:"object"===typeof f&&(g=f);3>b.length&&(e=!0);if(p&&(g&&g.message?d+=" ("+g.message+")":d&&(g=Error(d)),(b=a.strace(g))&&(l="\n\nStacktrace:\n"+b),
a.globalOpts.alerts&&(d&&"string"===typeof d&&0>d.search(/ERROR/)&&(m="JS9 ERROR: "),alert(m+(d+l))),e))throw g;};a.log=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];void 0!==window.console&&void 0!==window.console.log&&console.log.apply(console,$jscomp.arrayFromIterable(b))};a.eventToCharStr=function(c){var b={37:"leftArrow",38:"upArrow",39:"rightArrow",40:"downArrow",8:"delete"},d={188:"44",109:"45",190:"46",191:"47",192:"96",220:"92",222:"39",221:"93",219:"91",173:"45",
187:"61",186:"59",189:"45"},e={96:"~",49:"!",50:"@",51:"#",52:"$",53:"%",54:"^",55:"&",56:"*",57:"(",48:")",45:"_",61:"+",91:"{",93:"}",92:"|",59:":",39:'"',44:"<",46:">",47:"?"};var f="number"===typeof c?c:c.which||c.keyCode;var g=String(f);({}).hasOwnProperty.call(d,g)&&(f=d[g]);f=!c.shiftKey&&65<=f&&90>=f?String.fromCharCode(f+32):!c.shiftKey&&{}.hasOwnProperty.call(b,f)?b[f]:c.shiftKey&&{}.hasOwnProperty.call(e,f)?e[f]:String.fromCharCode(f);a.specialKey(c)&&(f="M-"+f);return f};a.eventToDisplayPos=
function(a,b){a||(a=window.event);if(a.target)var c=a.target;else a.srcElement&&(c=a.srcElement);3===c.nodeType&&(c=c.parentNode);b=b||$(c).offset();if(a.originalEvent)if(a.originalEvent.touches&&a.originalEvent.touches.length){var e=a.originalEvent.touches;c=e[0].pageX;var f=e[0].pageY}else a.originalEvent.changedTouches&&a.originalEvent.changedTouches.length?(e=a.originalEvent.changedTouches,c=e[0].pageX,f=e[0].pageY):(c=a.pageX,f=a.pageY);else c=a.pageX,f=a.pageY;a=b.left+1;b=b.top+1;f={x:Math.floor(c-
a),y:Math.floor(f-b)};if(e&&e.length)for(f.touches=[{x:f.x,y:f.y}],c=1;c<e.length;c++)f.touches[c]={x:Math.floor(e[c].pageX-a),y:Math.floor(e[c].pageY-b)};return f};a.pix2pix=function(c,b,d){if(!c||!b||0>=c.raw.wcs||0>=b.raw.wcs)return d;var e=d.x;d=d.y;var f=a.pix2wcs(c.raw.wcs,e,d).trim().split(/\s+/);var g=a.saostrtod(f[0]);a.isHMS(c.params.wcssys)&&(g*=15);c=a.saostrtod(f[1]);f=a.wcs2pix(b.raw.wcs,g,c).trim().split(/\s+/);b=parseFloat(f[0]);c=parseFloat(f[1]);.5>Math.abs(b-e)&&(b=e);.5>Math.abs(c-
...
"enabled":"disabled",done:function(){k.results=g.find("mark");k.currentIndex=0;f()}})}})},e=function(b){var a=b.prop("data-btn");k.opts[a]?(b.removeClass("JS9SearchButton-false"),b.addClass("JS9SearchButton-true")):(b.removeClass("JS9SearchButton-true"),b.addClass("JS9SearchButton-false"))},f=function(){if(k.results.length){var b=k.results.eq(k.currentIndex);k.results.removeClass("current");b.length&&(b.addClass("current"),b=b.position().top,0>b||b>h.height())&&(b=b+h.scrollTop()-50,h.scrollTop(b))}};
b=b||".JS9AnalysisText";if(c.is(b))var g=c;else if(g=c.find(b),!g.length)return;var h=c.find(a.lightOpts[a.LIGHTWIN].drag);h.length||(h=c);var k=h.find(".JS9Searchbar");if(k.length)k.css("display","block");else{k=$("<div>").addClass("JS9Searchbar").appendTo(h);k.opts={matchcase:!1,matchdiacritics:!1,matchwords:!1,matchwildcards:!1};var m=$("<input type='search'>").addClass("JS9SearchInput").appendTo(k);m.on("input",function(){d(m.val())});k.opts.matchwildcards?m.prop("placeholder","sea*rch template?"):
m.prop("placeholder","search term(s)");b=$("<button>").addClass("JS9SearchButton").prop("data-btn","next").html("&darr;").appendTo(k);var l=$("<button>").addClass("JS9SearchButton").prop("data-btn","prev").html("&uarr;").appendTo(k);b.add(l).on("click",function(b){k.results&&k.results.length&&(k.currentIndex+=$(b.currentTarget).is(l)?-1:1,0>k.currentIndex&&(k.currentIndex=k.results.length-1),k.currentIndex>k.results.length-1&&(k.currentIndex=0),f())});var p=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+
k.opts.matchcase).prop("data-btn","matchcase").html("Match Case").appendTo(k);p.on("click",function(){k.opts.matchcase=!k.opts.matchcase;e(p);d(m.val())});e(p);var r=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchdiacritics).prop("data-btn","matchdiacritics").html("Match Diacritics").appendTo(k);r.on("click",function(){k.opts.matchdiacritics=!k.opts.matchdiacritics;e(r);d(m.val())});e(r);var n=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchwords).prop("data-btn",
"matchwords").html("Whole Words").appendTo(k);n.on("click",function(){k.opts.matchwords=!k.opts.matchwords;e(n);d(m.val())});e(n);var u=$("<button>").addClass("JS9SearchButton JS9SearchButton-"+k.opts.matchwildcards).prop("data-btn","matchwildcards").html("Wildcards").appendTo(k);u.on("click",function(){k.opts.matchwildcards=!k.opts.matchwildcards;k.opts.matchwildcards?m.prop("placeholder","sea*rch template?"):m.prop("placeholder","search term(s)");e(u);d(m.val())});e(u);$("<button>").addClass("JS9SearchButton").prop("data-btn",
"close").html("Close").appendTo(k).on("click",function(){g.unmark();m.val("");k.css("display","none")});h.css("outline","none");h.attr("tabindex","0");h.on("keydown",function(b){var c=String.fromCharCode(b.which||b.keyCode);a.specialKey(b)&&"F"===c&&("none"===k.css("display")?(k.css("display","block"),m.focus()):(g.unmark(),m.val(""),k.css("display","none")))})}};a.tooltip=function(c,b,d,e,f,g){var h=function(b){return b.replace(/\$([a-zA-Z0-9_./]+)/g,function(b,c,d){c=c.split(".");switch(c[0]){case "im":d=
...
d.pos0;d.ipos0=d.displayToImagePos(d.pos);d.ipos=d.ipos0;b.resizing=b.inResize(d.pos);if(!b.resizing){c.preventDefault();({}).hasOwnProperty.call(a,"MouseTouch")&&a.MouseTouch.action(d,c,"start");if(d.clickInRegion&&"regions"===d.clickInLayer){d.display.clearMessage("regions");return}a.specialKey(c)||d.xeqPlugins("mouse","onmousedown",c)}d.clickState=c.which;switch(c.which){case 3:d.clickState=2}c.originalEvent&&c.originalEvent.touches&&c.originalEvent.touches.length&&(d.clickState=-c.originalEvent.touches.length);
...
JS9.inited&&$(document).trigger("JS9:ready",{status:"OK"})});$(document).on("JS9:helperReady",function(){JS9.fits.ready&&JS9.inited&&!JS9.readied&&$(document).trigger("JS9:ready",{status:"OK"})});0===$('div[data-js9init="false"]').length&&($(document).trigger("JS9:Start"),JS9.init())});
